...
public class P21_calculate_total_electricity_bill 
{
	public static void main(String[] args) 
	{
		...
		Double AdditionalSubcharges = charges * 0.20;
		System.out.println("additional surcharges of 20% is added to the bill: \t" + AdditionalSubcharges);
		
		double totalbill = charges + AdditionalSubcharges;
