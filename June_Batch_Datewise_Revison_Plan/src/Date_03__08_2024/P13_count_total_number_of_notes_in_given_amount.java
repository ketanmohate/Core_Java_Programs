...
public class P13_count_total_number_of_notes_in_given_amount 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("print total number of notes in given amount");
