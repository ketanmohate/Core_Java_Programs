...
/*
 Q 3. Create a class called Library to hold accession number,title of the book,author name,price of the book and 
write a menu driven program in java that implements the working of a library :
...
class displayMenu
{
	...
	Library[] arrLibrary;
	int bookCount = 0;  // Variable to track the number of books
...
//			lObj.set(accessionNo, title, authorName, price);
			...
			arrLibrary[i] = lObj;
			bookCount++;  // Increment book count for each addition
		}
	}
	...
	public void displayBookCount()
	{
		...
		if(arrLibrary != null)
		{
			System.out.println("Count Of The Book In The Library------>"+bookCount);
		}
		else
		{
			System.out.println("----------------------------------------------------------");
...
//			boolean found5 = false;
	...
	{
		System.out.println("==========================================================");
		System.out.println("Delete book details by price");
		System.out.println("==========================================================");
		...
		if(arrLibrary != null)
		{
			...
			for(int i=0;i<arrLibrary.length;i++)
			{
				if(arrLibrary[i] != null)
				{
					if(arrLibrary[i].getPrice()==price)
					{
						arrLibrary[i]=null;
						bookCount--;  // Decrement book count
						System.out.println("Book Details Is Deleted");
						System.out.println("----------------------------------------------------------");
						found6=true;
					}
				}
