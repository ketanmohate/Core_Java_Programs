...
class Login extends JFrame implements ActionListener {
    ...
    Login() {
        ...
        b4 = new JButton("Sign Up", new ImageIcon("images//signup.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                ...
                if (SignUp.userDatabase.containsKey(s) && SignUp.userDatabase.get(s).equals(s1)) {
                    JOptionPane.showMessageDialog(null, " Welcome !!! You are a valid user ...!!!  ", "WELCOME", JOptionPane.INFORMATION_MESSAGE);
                    jf.setVisible(false);
                    new MainMenu();
                } else {
